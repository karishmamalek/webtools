...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Filament::serving(function(): void {
            //  Filament::registerTheme(mix('./public/css/theme.css'));
            
           // Filament::registerTheme('http://localhost/cybertools/public/css/theme.css');
            Filament::registerTheme(asset('css/theme.css'));
        });
