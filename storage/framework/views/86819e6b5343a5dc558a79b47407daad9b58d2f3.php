<section x-data="{ input: '', encoded: '' }">
    ...
    <button x-on:click="encoded = ''; for(let i=0;i<input.length;i++) { encoded += input[i].charCodeAt(0).toString(2) + ' ' };" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/text-to-binary.submit')); ?></button>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <div class="copy-textarea-btn">
                    <textarea x-text="encoded" type="email" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/text-to-binary.result-placeholder')); ?>" rows="5"></textarea>
...
</section><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/modules/tools/text-to-binary/view.blade.php ENDPATH**/ ?>