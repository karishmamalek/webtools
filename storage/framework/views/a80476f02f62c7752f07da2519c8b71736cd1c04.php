		...
		<div class="main-section">
			<header class="mainPadding">
				<nav class="p-0 navbar navbar-expand-lg navbar-dark">
					<a class="navbar-brand <?php echo e($theme == 'dark' ? 'dark' : ''); ?>" href="<?php echo e(url('/')); ?>"><img alt="top-logo" src="<?php echo e(storage_url( $theme == 'dark' ? $generalSettings->footerLogo : $generalSettings->logo )); ?>" class="img-responsivee"></a>
            ...
            <div class="row">
				...
				<div class="<?php echo e($generalSettings->contactPage ? 'col-lg-6' : 'col-lg-12'); ?>">
					<footer>
						<div class="footer-logo"><a href="<?php echo e(url('/')); ?>"><img alt="footer-logo" src="<?php echo e(storage_url( $generalSettings->footerLogo )); ?>" alt=""></a></div>
...
</html><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/layouts/main.blade.php ENDPATH**/ ?>