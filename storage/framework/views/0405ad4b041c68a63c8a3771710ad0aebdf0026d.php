...
} elseif ($_instance->childHasBeenRendered('NnObD19')) {
    $componentId = $_instance->getRenderedChildComponentId('NnObD19');
    $componentTag = $_instance->getRenderedChildComponentTagName('NnObD19');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NnObD19');
} else {
    $response = \Livewire\Livewire::mount('contact');
    $html = $response->html();
    $_instance->logRenderedChild('NnObD19', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/contact.blade.php ENDPATH**/ ?>