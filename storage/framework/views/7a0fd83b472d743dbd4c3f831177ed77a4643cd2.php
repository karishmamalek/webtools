...
} elseif ($_instance->childHasBeenRendered('SXCxQ5x')) {
    $componentId = $_instance->getRenderedChildComponentId('SXCxQ5x');
    $componentTag = $_instance->getRenderedChildComponentTagName('SXCxQ5x');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SXCxQ5x');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('SXCxQ5x', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('XiPtP4j')) {
    $componentId = $_instance->getRenderedChildComponentId('XiPtP4j');
    $componentTag = $_instance->getRenderedChildComponentTagName('XiPtP4j');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XiPtP4j');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('XiPtP4j', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\cybertools\vendor\filament\filament\src\/../resources/views/components/layouts/app.blade.php ENDPATH**/ ?>