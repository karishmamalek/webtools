    ...
    <div>
        ...
        <?php if($this->licenseError !== false): ?>
            <div class="mt-3 w-full p-2 bg-red-800 text-red-100 items-center leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                ...
                <span class="font-semibold mr-2 text-left flex-auto"><?php echo e($this->licenseError); ?></span>
            </div>
        <?php endif; ?>
...
</form><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/install/locker.blade.php ENDPATH**/ ?>