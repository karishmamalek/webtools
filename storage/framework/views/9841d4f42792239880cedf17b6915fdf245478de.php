<div x-data="window.bitflanFormattersComponent()">
    ...
    <button x-on:click="minifyHtml()" class="btn custom--btn button__lg"><?php echo e(trans('webtools/tools/html-minifier.label')); ?></button>
</div><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/modules/tools/html-minifier/view.blade.php ENDPATH**/ ?>