        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade" x-bind:class="(type == 'url' || type == 'text') && 'show active'">
                <div class="form-group">
                    <label for="" class="custom-label"><?php echo e(trans('webtools/tools/qr-generator.content-here-label')); ?></label>
            ...
            <div class="tab-pane fade" x-bind:class="(type == 'vcard') && 'show active'">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.fname" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-firstname')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.lname" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-lastname')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="vcard.mobile" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-mobile')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.phone" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-phone')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.fax" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-fax')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="vcard.email" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-email')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.company" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-company')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.job" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-job')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="vcard.street" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-street')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.city" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-city')); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input x-model="vcard.zip" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-zip')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="vcard.state" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-state')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="vcard.country" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-country')); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <input x-model="vcard.website" type="text" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/qr-generator.vcard-website')); ?>">
                        </div>
                    </div>
                </div>
                <button class="btn custom--btn button__lg" @click="generate()"><?php echo e(trans('webtools/tools/qr-generator.submit')); ?></button>
...
</div><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/modules/tools/qr-generator/view.blade.php ENDPATH**/ ?>