<section>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div class="copy-textarea-btn">
                        <textarea id="csvArea" class="rounded custom-textarea" placeholder="<?php echo e(trans('webtools/tools/json-to-csv.result-placeholder')); ?>" rows="5">!! $this->csv !!}</textarea>
    ...
    <?php elseif($this->code == 1): ?>
        ...
        <div class="border-0 alert alert-danger rounded-pill bg-danger">
            <h5 class="m-0 d-inline-block text-light p-l-25"><?php echo e(trans('webtools/tools/json-to-csv.error-text')); ?></h5>
            <h5 class="float-end p-r-25 text-light"><?php echo e(trans('webtools/tools/json-to-csv.error')); ?></h5>
        </div>
    <?php endif; ?>
</section><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/modules/tools/json-to-csv/livewire.blade.php ENDPATH**/ ?>