<form wire:submit.prevent="submit">
        ...
        <?php else: ?>
            <div class="form-group">
                <div class="border-0 alert alert-danger rounded-pill bg-danger">
                    <h5 class="m-0 d-inline-block text-light p-l-25"><?php echo e(trans('webtools/tools/ssl-checker.error-invalid')); ?></h5>
                </div>
            </div>
        <?php endif; ?>
    <?php elseif($this->status === 'failure'): ?>
        <div class="form-group">
            <div class="border-0 alert alert-danger rounded-pill bg-danger">
                <h5 class="m-0 d-inline-block text-light p-l-25"><?php echo e(trans('webtools/tools/ssl-checker.error-notfound')); ?></h5>
            </div>
        </div>
    <?php endif; ?>
...
</form><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/modules/tools/ssl-checker/livewire.blade.php ENDPATH**/ ?>