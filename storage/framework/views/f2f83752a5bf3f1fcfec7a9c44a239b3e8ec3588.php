...
} elseif ($_instance->childHasBeenRendered('l0hpFG7')) {
    $componentId = $_instance->getRenderedChildComponentId('l0hpFG7');
    $componentTag = $_instance->getRenderedChildComponentTagName('l0hpFG7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l0hpFG7');
} else {
    $response = \Livewire\Livewire::mount($wireComponent);
    $html = $response->html();
    $_instance->logRenderedChild('l0hpFG7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php else: ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cybertools\resources\views/modules/tool-base.blade.php ENDPATH**/ ?>